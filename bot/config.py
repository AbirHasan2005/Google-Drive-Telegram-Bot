class config:
    BOT_TOKEN = "1419873726:AAGUKtR6ifvpp_0MKX2_hQYASXFgG7B-SA8"
    APP_ID = "1917410"
    ...
    SUPPORT_CHAT_LINK = "https://t.me/jigargdrive"
    DOWNLOAD_DIRECTORY = "./Downloads/Jigar_gdrive_bot/"
